...
@Composable
fun LedgerDetailCategoryBottomSheet(
    ...
    var sheetType by remember { mutableStateOf(BottomSheetType.LIST) }
            ...
            when (targetState) {
                BottomSheetType.LIST -> {
                    CategoryListContent(
                        ...
                        onDismissRequest = onDismissRequest,
                        onClickCreate = { sheetType = BottomSheetType.CREATE },
                ...
                BottomSheetType.CREATE -> {
                    CategoryCreateContent(
                        ...
                        onPrev = {
                            sheetType = BottomSheetType.LIST
...
@Composable
private fun CategoryCreateContent(
    modifier: Modifier = Modifier,
