...
class AgencyRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun agencyCodeNumbers(data: AgencyJoinRequest): Result<AgencyJoinResponse> {
            return agencyRemoteDataSource.agencyCodeNumbers(data)
        }

        override suspend fun saveAgencyId(agencyId: Int) = agencyLocalDataSource.saveAgencyId(agencyId = agencyId)

        override suspend fun fetchAgencyId(): Int = agencyLocalDataSource.fetchAgencyId()
    }
