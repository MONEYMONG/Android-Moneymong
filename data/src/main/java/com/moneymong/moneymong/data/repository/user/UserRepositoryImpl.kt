...
class UserRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun logout(): Result<Unit> {
            val refreshToken =
                loginLocalDataSource.getRefreshToken().getOrElse {
        ...
        override suspend fun saveUserId(userId: Int) = userLocalDataSource.saveUserId(userId = userId)

        override suspend fun fetchUserId(): Int = userLocalDataSource.fetchUserId()
        ...
        override suspend fun saveUserNickName(nickname: String) =
            userLocalDataSource.saveUserNickName(
                nickname = nickname,
            )

        override suspend fun fetchUserNickName(): String = userLocalDataSource.fetchUserNickName()
        ...
        override suspend fun fetchDeniedCameraPermission(): Boolean = userLocalDataSource.fetchDeniedCameraPermission()
    }
